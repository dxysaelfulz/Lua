...
local btn1 = makeButton("Teleport To Safe",0.22,Color3.fromRGB(70,70,70))
local btn2 = makeButton("Teleport To End Zone",0.42,Color3.fromRGB(90,70,120))
local speedBtn = makeButton("Speed: OFF",0.62,Color3.fromRGB(60,120,60))
